...
export const navigationItems = [
  ...
  { label: "Grower Cohorts", href: "/planner#grower-segments", icon: UsersRound, roles: ["Campaign Manager", "Territory Manager", "Field Representative"] },
  { label: "Field Execution", href: "/field-actions", icon: ClipboardList, roles: ["Territory Manager", "Field Representative"] },
  { label: "Retailer Coverage", href: "/field-actions#retailer-alerts", icon: Store, roles: ["Territory Manager", "Retailer Support", "Campaign Manager"] },
  { label: "Campaign Signals", href: "/recommendations#analytics", icon: BarChart3, roles: ["Campaign Manager", "Territory Manager", "Retailer Support"] },
  { label: "Control Settings", href: "/planner#settings", icon: Settings, roles: ["Campaign Manager"] }
];
