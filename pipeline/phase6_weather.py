...
def run_phase6():
    """Execute Phase 6: Weather Risk Signals."""

    print("=" * 60)
    print("PHASE 6: Weather Risk Signals")
    print("=" * 60)
    ...
    print(f"\n✅ Phase 6 complete. Weather-enriched feature table saved.")
    return True
...
def validate_phase():
    """Validate output of Phase 6."""
    return os.path.exists(FEATURE_TABLE_WEATHER)
